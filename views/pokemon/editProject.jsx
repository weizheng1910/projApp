        ...
        <Layout userid={this.props.userid}>
          ...
          <form action = {`/user/${this.props.userid}/editProject/${this.props.boardid}?_method=put`} method="POST">
            ...
            <div className="form-group col-md-6 mx-1">
              ...
              <input type="text" name="projname" value={this.props.project.name} className="form-control"/>
            </div>

            <div className="form-group col-md-6 mx-1">
              <label>Description</label>
              <textarea rows="10" name="description" value={this.props.project.description} className="form-control"/>
            </div>
